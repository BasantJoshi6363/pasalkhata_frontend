...
import { ArrowLeft, PlusCircle, Calendar, FileText, QrCode, Download, CreditCard } from 'lucide-react';
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
          ...
          <form onSubmit={handleTransactionSubmit} className="space-y-3.5">
            ...
            <div>
              ...
              <textarea 
                rows="3" placeholder="e.g., Bought 5kg Sugar" value={description} onChange={(e) => setDescription(e.target.value)}
